...
urlpatterns = [
    ...
    path("otherbanks",transfer.otherbank,name="otherbank"),
    path("initiate_payout_view",transfer.otherbank,name="initiate_payout"),
    ...
    path("all/<card_id>/", credit_card.all_cards, name="All"),
]